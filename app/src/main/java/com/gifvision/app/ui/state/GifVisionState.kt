 ...
 */
enum class GifVisionBlendMode(val displayName: String, val ffmpegKeyword: String) {
    Normal("Normal", "normal"),
    Addition("Addition", "addition"),
    Addition128("Addition (128)", "addition128"),
    And("Logical AND", "and"),
    Average("Average", "average"),
    Bleach("Bleach", "bleach"),
    Color("Color", "color"),
    ColorBurn("Color Burn", "burn"),
    ColorDodge("Color Dodge", "dodge"),
    Darken("Darken", "darken"),
    Difference("Difference", "difference"),
    Difference128("Difference (128)", "difference128"),
    ...
    Glow("Glow", "glow"),
    GrainExtract("Grain Extract", "grainextract"),
    GrainMerge("Grain Merge", "grainmerge"),
    HardLight("Hard Light", "hardlight"),
    HardMix("Hard Mix", "hardmix"),
    HardOverlay("Hard Overlay", "hardoverlay"),
    Harmonic("Harmonic", "harmonic"),
    Heat("Heat", "heat"),
    Hue("Hue", "hue"),
    Interpolate("Interpolate", "interpolate"),
    Lighten("Lighten", "lighten"),
    LinearLight("Linear Light", "linearlight"),
    Luminosity("Luminosity", "luminosity"),
    Multiply("Multiply", "multiply"),
    Multiply128("Multiply (128)", "multiply128"),
    Negation("Negation", "negation"),
    Or("Logical OR", "or"),
    Overlay("Overlay", "overlay"),
    Phoenix("Phoenix", "phoenix"),
    PinLight("Pin Light", "pinlight"),
    Reflect("Reflect", "reflect"),
    Saturation("Saturation", "saturation"),
    Screen("Screen", "screen"),
    SoftDifference("Soft Difference", "softdifference"),
    SoftLight("Soft Light", "softlight"),
    Stain("Stain", "stain"),
